        ...
        return [
            ...
            new Example(
                ...
                notes: [
                    ...
                    'Opt in per column with $facets: it is one extra grouped query, run only when a dropdown is actually opened.',
                    'Computed and relationship columns are refused: a count has to be one GROUP BY on a real column, not a per-row calculation.',
                ],
                keywords: ['facets', 'counts', 'filter counts', 'faceted search'],
            ),
            new Example(
                id: 'filters',
                category: 'Filters',
            ...
            new Example(
                ...
                category: 'Data types',
                title: 'Soft deletes',
                description: 'Without trashed, with trashed, only trashed — opt-in.',
                table: DynamicTables\SoftDeletesTable::class,
                notes: [
                    'The feature is opt-in because most tables do not want it; the package never assumes a model uses SoftDeletes.',
            ...
            new Example(
                id: 'minimal-theme',
                category: 'UI',
                title: 'Minimal theme (no framework)',
                description: 'Ready to use with no CSS framework on the page at all.',
                table: DynamicTables\MinimalThemeTable::class,
                notes: [
